...
public class SearchManagerTest {
	...
	public void searchManagerTest() throws Exception {
		final TestValue[] testValueArray = {
			...
			new TestValue("3r3k/8/1b6/8/3r4/8/2N5/3Q3K w - - 0 1", 1, PieceTypeEvaluations.getPieceTypeEvaluation(PieceType.QUEEN) - PieceTypeEvaluations.getPieceTypeEvaluation(PieceType.ROOK) - PieceTypeEvaluations.getPieceTypeEvaluation(PieceType.BISHOP), "c2d4"),
