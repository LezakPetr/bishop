...
modelWin = glm(isWin~defendantInCheck+attackerPawnCount+defendantPawnCount+defendantPawnCountOneMoveToPromotion+defendantPawnCountOneMoveToPromotionWithCheck+defendantPawnCountTwoMovesToPromotion+attackerKingInMateRisk+defendantKingInMateRisk+queenProtected+queenAttacked,family=binomial(link='logit'), data = data);
modelLose = glm(isLose~defendantInCheck+attackerPawnCount+defendantPawnCount+defendantPawnCountOneMoveToPromotion+defendantPawnCountOneMoveToPromotionWithCheck+defendantPawnCountTwoMovesToPromotion+attackerKingInMateRisk+defendantKingInMateRisk+queenProtected+queenAttacked,family=binomial(link='logit'), data = data);
