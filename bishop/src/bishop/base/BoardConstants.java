...
public class BoardConstants {
    ...
    // First and eight rank must be preserved to be able to calculate reverse attacks.
    ...
    private static final int[] TABLE_CASTLING_ROOK_BEGIN_SQUARE = {
    	Square.H1, Square.A1,
    	Square.H8, Square.A8
    };
    
    // Target squares of rook in castling.
    private static final int[] TABLE_CASTLING_ROOK_TARGET_SQUARE = {
    	Square.F1, Square.D1,
    	Square.F8, Square.D8
    };
    ...
    private static final int[] TABLE_CASTLING_KING_TARGET_SQUARE = {
    	Square.G1, Square.C1,
    	Square.G8, Square.C8
    };   

    // Middle squares of king in castling.
    private static final int[] TABLE_CASTLING_KING_MIDDLE_SQUARE = {
    	Square.F1, Square.D1,
    	Square.F8, Square.D8
    };   
    ...
    private static final int[] PAWN_PROMOTION_DISTANCES = {
    ...
    private static final long[] SQUARE_COLOR_MASKS = {
    	WHITE_SQUARE_MASK,
    	BLACK_SQUARE_MASK
    };
	...
	/**
	 * Returns mask of squares in front of given square on same and neighbour files.
	 * @param color color of player
	 * @param square square
